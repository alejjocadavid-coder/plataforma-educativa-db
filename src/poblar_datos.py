...
# DESCRIPCIÓN: Script de generación e inserción masiva de datos realistas
#              (1.500 estudiantes y 24.000 registros de progreso lógico)
...
fake = Faker('es_CO') # Generador de datos en español de Colombia
Faker.seed(42)
random.seed(42)
...
try:
    ...
    # Ajustado a tabla ESTUDIANTES en mayúsculas
    query_estudiantes = """
    ...
    # =========================================================================
    # PASO 2: Obtener Cursos y Módulos Existentes (Tablas en Mayúsculas)
    # =========================================================================
    # Consultamos CURSOS y MODULOS respetando mayúsculas
    cursor.execute("SELECT id_curso FROM CURSOS")
    cursos = [row[0] for row in cursor.fetchall()]
    
    if not cursos:
        print("Error: No se encontraron cursos en la tabla 'CURSOS'. Ejecuta primero tus inserciones iniciales.")
        exit()
    ...
    # =========================================================================
    print("Generando inscripciones y registros de progreso coherentes...")
    inscripciones_data = []
    progreso_data = []
    ...
    # Insertar Inscripciones en la tabla INSCRIPCIONES (Mayúsculas)
    ...
    # Insertar Progreso en bloques en la tabla PROGRESO (Mayúsculas)
